...
#define CUSTOM_MACHINE_NAME "The Genobot"
...
// to check that the wiring to the thermistor is nostepterwise this would lead to the heater being powered on all the time.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {111.98, 111.98, 6863.27, 464.44}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3.5, 45}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // added some clearance (~+/- 5mm) for buildtak plate placement
